            ...
            >
                ...
                >
                    <ReactQueryProvider>
                        <SearchProvider>
                            <ClientInit>
                                <div className=" max-h-[100vh] lg:h-auto">
                                    {/* // begin:: Header  */}
                                    <Header />
                                    {/* // end:: Header  */}
                                    {/* begin:: App Main */}
                                    <main className="  relative flex flex-col items-center bg-sidebar-secondary/20 overflow-x-hidden  scroll-smooth overflow-y-scroll max-h-[80vh] lg:h-auto lg:overflow-y-auto">
                                        {/* // begin:: Children */}
                                        {children}
                                        {/* // end:: Children */}
                                    </main>
