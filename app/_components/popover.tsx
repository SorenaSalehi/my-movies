...
function PopoverTrigger({
    ...
    return (
        <PopoverPrimitive.Trigger
            ...
            {...props}
            className="hidden lg:flex sm:flex-1 h-15"
        />
    );
}
